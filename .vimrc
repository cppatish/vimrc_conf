...
"Plug 'nickhutchinson/vim-make-syntax'
"
"
...
"    let g:airline_section_y = 'BN: %{bufnr("%")}'
"    let g:airline_section_x = airline#section#create(['%P',':','%4l',',','%3c'])
"endfunction
     let g:airline_section_y = '%{strftime("%m/%d-%H:%M[%w]")}'
